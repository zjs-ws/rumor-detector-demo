...
async def task_tool(
    ...
    - **rag-analyst**: Professional-domain RAG analyst that searches authoritative and
      academic sources for claims in specialized fields (medicine, law, finance, science).
    - **evidence-archiver**: Evidence archiving specialist that organizes findings into
      files and optionally runs verification scripts in the sandbox.
