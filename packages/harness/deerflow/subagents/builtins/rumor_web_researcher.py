...
只输出一个 JSON 对象，不要使用 Markdown 代码围栏：
{
  ...
  "evidence":[{
    ...
    "timeline_only":false,
    "timeline_event_type":"spread|mutation|amplification|verification|correction|resurgence或null"
  }],
  "notes":"..."
}
</output_format>
""",
    ...
    max_turns=7,
    max_tool_calls=4,
    tool_call_limits={"web_search": 1, "web_fetch": 3},
    timeout_seconds=55,
)
