...
from .rumor_authority_researcher import RUMOR_AUTHORITY_RESEARCHER_CONFIG
from .rumor_evidence_archiver import RUMOR_EVIDENCE_ARCHIVER_CONFIG
from .rumor_evidence_critic import RUMOR_EVIDENCE_CRITIC_CONFIG
...
__all__ = [
    ...
    "RUMOR_EVIDENCE_CRITIC_CONFIG",
    "RUMOR_AUTHORITY_RESEARCHER_CONFIG",
]
...
BUILTIN_SUBAGENTS = {
    ...
    "evidence-critic": RUMOR_EVIDENCE_CRITIC_CONFIG,
    "authority-researcher": RUMOR_AUTHORITY_RESEARCHER_CONFIG,
}
