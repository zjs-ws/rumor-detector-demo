...
export function InputBox({
  ...
  return (
    <div ref={promptRootRef} className="relative max-w-full min-w-0">
      <PromptInput
        className={cn(
          "bg-background/85 max-w-full min-w-0 rounded-2xl backdrop-blur-sm transition-all duration-300 ease-out *:data-[slot='input-group']:min-w-0 *:data-[slot='input-group']:rounded-2xl",
          className,
        )}
        disabled={disabled}
        globalDrop
        ...
        <PromptInputFooter className="flex">
          ...
          <PromptInputActionMenu>
            ...
            {showRuntimeControls ? (
              ...
              <div className="text-rb-evidence flex items-center gap-1.5 px-2 text-xs font-medium">
